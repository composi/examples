...
gulp.task("watch", function (done) {
  ...
  gulp
    .watch(["./src/js/app.js", "src/js/**/*"])
    .on("change", gulp.series("build:js", reload));
...
gulp.task(
  "default",
  gulp.series("build:js", "build:css", "move-images", "watch", serve),
  function (done) {
    done();
  }
);
...
gulp.task(
  "fresh-build",
  gulp.series("build:js", "build:css", "move-images"),
  function (done) {
    done();
  }
);
...
gulp.task("production", function (done) {
  ...
  gulp.src("./index.html").pipe(gulp.dest(`../${name}`));
  done();
});
